<div id="headerMain" class="d-none">
    <header id="header" style="background-color: #EF3F3E"
            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('panel.dashboard')}}" aria-label="">
                    <img class="navbar-brand-logo" style="max-height: 42px;"
                         onerror="this.src='{{asset('back-end/assets/front-end/img/image-place-holder.png')}}'"
                         src="{{asset("back-end/assets/company/$e_commerce_logo")}}" alt="Logo">
                    <img class="navbar-brand-logo-mini" style="max-height: 42px;"
                         onerror="this.src='{{asset('back-end/assets/front-end/img/image-place-holder.png')}}'"
                         src="{{asset("back-end/assets/company/$e_commerce_logo")}}"
                         alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
            ...
            <div class="navbar-nav-wrap-content-right"
                ...
                {{--<li class="nav-item d-none d-sm-inline-block">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="{{route('panel.Restaurant.list')}}">
                                <i class="tio-shop"></i>
                                    <span class="btn-status btn-status btn-status-danger">{{ \App\Models\restaurant::where('restaurant_status',0)->orderby('restaurant_id','DESC')->count() }}</span>
                            </a>
                        </div>
                        <!-- End Notification -->
                    </li>
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="{{route('panel.Order.list',['status'=>'new'])}}">
                                <i class="tio-shopping-cart-outlined"></i>
                                <span class="btn-status btn-status btn-status-danger">{{ \App\Models\order_detail::where('order_status',0)->count() }}</span>
                            </a>
                        </div>
                        <!-- End Notification -->
                    </li>
                        ...
                        <div class="hs-unfold">
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item"
                                   href="{{route('panel.change_password')}}">
