...
<div class="content container-fluid">  <!-- Page Heading -->
    ...
    <div class="d-md-flex_ align-items-center justify-content-between mb-2">
        <div class="row">
            <div class="col-md-8">
                <h3 class="h3 mb-0 text-black-50">{{('Category')}} {{('List')}}</h3>
            </div>
        </div>
    </div>
                    ...
                    <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                        <div class="col-12 mb-1 col-md-2">
                            <h5 class="flex-between">
                                <div>{{('Category Table')}} ({{ $categories->total() }})</div>
                            </h5>
                        </div>
                            ...
                            @foreach($categories as $key=>$c)
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$c->cat_id}}">
                                            <input type="checkbox" onclick="status_change_alert('{{route('panel.Category.status-update-show',[$c->cat_id,$c->is_show?0:1])}}', '{{('You want to change this category status')}}', event)" class="toggle-switch-input" id="stocksCheckbox{{$c->cat_id}}" {{$c->is_show?'checked':''}}>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('panel.Category.update')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
