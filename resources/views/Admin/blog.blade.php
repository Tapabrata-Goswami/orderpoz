...
<div class="content container-fluid">  <!-- Page Heading -->
    ...
    <div class="d-md-flex_ align-items-center justify-content-between mb-2">
        <div class="row">
            <div class="col-md-8">
                <h3 class="h3 mb-0 text-black-50">{{('Blog')}} {{('List')}}</h3>
            </div>
        </div>
    </div>
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group input-group-merge input-group-flush">
                                    ...
                                    <input id="datatableSearch_" type="search" name="search" class="form-control"
                                           placeholder="{{('Search Blog')}}" aria-label="Search Blog"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-8 js-form-message">
                                                    <input type="text" class="form-control" name="blog_title" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-8 js-form-message">
                                                    <input type="text" class="form-control" name="blog_person" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-8 js-form-message">
                                                    <textarea name="blog_description" class="form-control ckeditor" cols="100" rows="2" ></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" style="margin-bottom:0%;">
                                                <center>
                                                    <img style="width: 150px;border: 1px solid; border-radius: 10px;" id="viewer"
                                                        ...
                                                        src="{{asset('image')}}/{{$blog['blog_image']}}"
                                                        @else
                ...
                <div class="card-body" style="padding: 0">
                    <div class="table-responsive datatable-custom">
                        <table id="datatable" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                            ...
                            <tbody>
                            @foreach($blog as $key=>$o)
                                <tr>
                                    <td>{{$key+$blog->firstItem()}}</td>
                                    <td>{{$o['blog_title']}}</td>
                                    <td>{{$o['blog_person']}}</td>
                                    <td><img class="mb-3" src="{{asset('image')}}/{{$o['blog_image']}}" style="width: 4rem;"></td>
                                    <td>{{$o['blog_description']}}</td>
                                    <td>{{ \Carbon\Carbon::parse( $o->created_at )->format('d/m/Y') }}</td>
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$o->blog_id}}">
                                            <input type="checkbox" onclick="status_change_alert('{{route('panel.Blog.status-update',[$o->blog_id,$o->blog_status?0:1])}}', '{{('You want to change this blog status')}}', event)" class="toggle-switch-input" id="stocksCheckbox{{$o->blog_id}}" {{$o->blog_status?'checked':''}}>
                                    ...
                                    <td>
                                        ...
                                        href="javascript:" data-toggle="modal" data-target="#edit-modal{{$o->blog_id}}" title="Edit Blog">
                                ...
                                <div id="edit-modal{{$o->blog_id}}" class="modal fade" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalTopCoverTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <!-- Header -->
                                        ...
                                        <form action="{{route('panel.Blog.update')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-8 js-form-message">
                                                        <input type="text" class="form-control" name="blog_title" value="{{$o['blog_title']}}" required>
                                                        <input type="hidden" class="form-control" name="blog_id" value="{{$o['blog_id']}}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-8 js-form-message">
                                                        <input type="text" class="form-control" name="blog_person" value="{{$o['blog_person']}}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-8 js-form-message">
                                                        <textarea name="blog_description" class="form-control ckeditor" cols="100" rows="2" >{{$o['blog_description']}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-8">
                                                    <div class="custom-file">
                                                        <input type="file" name="image" id="customFileEg2{{$o['blog_id']}}" class="custom-file-input" accept=".jpg, .png, .jpeg|image/*" onchange="imagechange({{$o['blog_id']}},this)">

                                                        <label class="custom-file-label" for="customFileEg2{{$o['blog_id']}}">{{__('choose')}} {{__('file')}}</label>
                                                ...
                                                <div class="form-group" style="margin-bottom:0%;">
                                                    <center>
                                                        <img style="width: 150px;border: 1px solid; border-radius: 10px;" id="viewer2{{$o['blog_id']}}"
                                                            @if(isset($o['blog_image']))
                                                                src="{{asset('image')}}/{{$o['blog_image']}}"
                                                            @else
                                                                src="{{asset('back-end/assets/back-end/img/900x400/img1.jpg')}}"
                                                            @endif
                                                            alt="image"/>
