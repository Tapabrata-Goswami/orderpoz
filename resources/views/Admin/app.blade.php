...
<head>
    ...
    <link rel="stylesheet" href="{{asset('back-end/assets')}}/back-end/css/custom.css">
    ...
    @if(Session::get('direction') === "rtl")
        <link rel="stylesheet" href="{{asset('back-end/assets')}}/back-end/css/menurtl.css">
    @endif
    @stack('css_or_js')
    <style>
        :root {
    ...
    <script
        src="{{asset('back-end/assets')}}/back-end/vendor/hs-navbar-vertical-aside/hs-navbar-vertical-aside-mini-cache.js"></script>
        ...
        <div class="col-md-12">
            <div id="loading" style="display: none;">
                <div style="position: fixed;z-index: 9999; left: 40%;top: 37% ;width: 100%">
                    <img width="200" src="{{asset('back-end/assets/back-end/img/loader.gif')}}">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-12">
                        <center>
                            <h2 style="color: rgba(96,96,96,0.68)">
                                <i class="tio-shopping-cart-outlined"></i> {{('You have new restaurant order, Check Please.')}}
                            </h2>
                            <hr>
...
<script src="{{asset('back-end/assets')}}/back-end/js/custom.js"></script>
...
<script src="{{asset('back-end/assets')}}/back-end/js/bootstrap.min.js"></script>

<script>
        // setInterval(function () {
        //     $.get({
        //         url: '{{route('panel.get-new-order')}}',
        //         dataType: 'json',
        //         success: function (response) {
        //             let data = response.data;
        //             if (data.new_booking > 0) {
        //                 $('#popup-modal1').appendTo("body").modal('show');
        //             }
        //         },
        //     });
        // }, 10000);
        ...
        //         location.href = "{{route('panel.Order.list',['status'=>'new'])}}";
...
<!-- IE Support -->
<script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="{{asset('back-end/assets')}}/back-end/vendor/babel-polyfill/polyfill.min.js"><\/script>');
</script>
@stack('script_2')
