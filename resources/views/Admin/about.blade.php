...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('panel.Detail.change-about')}}" method="POST" enctype="multipart/form-data" id="mobile-info">
                @csrf
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group lang_form" id="form">
                                        <textarea name="about_us" class="form-control ckeditor" cols="100" rows="2" >@if(!empty($about)){{$about->about_us}}@endif</textarea>
                                    </div>
                                </div>
                            </div>   
                        </div>
