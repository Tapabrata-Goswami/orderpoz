...
@section('title', ('Item Add-on List'))
...
<div class="content container-fluid">  <!-- Page Heading -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{('Item Add-ons')}}</li>
        </ol>
    </nav>
    ...
    <div class="d-md-flex_ align-items-center justify-content-between mb-2">
        <div class="row">
            <div class="col-md-8">
                <h3 class="h3 mb-0 text-black-50">{{('Item Add-on')}} {{('List')}}</h3>
            </div>
        </div>
    </div>
                    ...
                    <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                        <div class="col-12 mb-1 col-md-2">
                            <h5 class="flex-between">
                                <div>{{('Item Add-on Table')}} ({{ $item->total() }})</div>
                            </h5>
                        </div>
                        ...
                        <div class="col-12 col-md-3">
                            <a href="javascript:" data-toggle="modal" data-target="#category-modal" class="btn btn-primary">
                                ...
                                <span class="text">{{('Add Item Add-on')}}</span>
                            </a>
                        </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-8 js-form-message">
                                                    <input type="text" class="form-control" name="add_on_name" value="" required>
                                                    <input type="hidden" class="form-control" name="menu_id" value="{{$restaurant_cat_id}}" required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-white btn-sm" href="javascript:"
                                           onclick="status_change_alert('{{route('panel.Item.delete-addon',[$c->add_on_id])}}','{{('Want to delete this add-on ?')}}',event)">
