...
<div class="content container-fluid">  <!-- Page Heading -->
    ...
    <div class="d-md-flex_ align-items-center justify-content-between mb-2">
        <div class="row">
            <div class="col-md-8">
                <h3 class="h3 mb-0 text-black-50">{{('Country')}} {{('List')}}</h3>
            </div>
        </div>
    </div>
                    ...
                    <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                        <div class="col-12 mb-1 col-md-2">
                            <h5 class="flex-between">
                                <div>{{('Country Table')}} ({{ $country->total() }})</div>
                            </h5>
                        </div>
                        ...
                        <div id="offer-modal" class="modal fade" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('panel.Country.store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-8 js-form-message">
                                                    <input type="text" class="form-control" name="country_code" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-8 js-form-message">
                                                    <input type="text" class="form-control" name="country_currency" value="" required>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="card-body" style="padding: 0">
                    <div class="table-responsive datatable-custom">
                        <table id="datatable" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                            ...
                            <tbody>
                            @foreach($country as $key=>$o)
                                <tr>
                                    <td>{{$key+$country->firstItem()}}</td>
                                    <td>{{$o['country_name']}}</td>
                                    <td>{{$o['country_code']}}</td>
                                    <td>{{$o['country_currency']}}</td>
                                    <td>
                                        <a class="btn btn-white btn-sm"
                                        href="javascript:" data-toggle="modal" data-target="#edit-modal{{$o->country_id}}" title="Edit Country">
                                ...
                                <div id="edit-modal{{$o->country_id}}" class="modal fade" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalTopCoverTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <!-- Header -->
                                        ...
                                        <form action="{{route('panel.Country.update')}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-8 js-form-message">
                                                        <input type="text" class="form-control" name="country_name" value="{{$o['country_name']}}" required>
                                                        <input type="hidden" class="form-control" name="country_id" value="{{$o['country_id']}}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-8 js-form-message">
                                                        <input type="text" class="form-control" name="country_code" value="{{$o['country_code']}}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-8 js-form-message">
                                                        <input type="text" class="form-control" name="country_currency" value="{{$o['country_currency']}}" required>
                                                    </div>
                                                </div>
