    ...
    <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('panel.Restaurant.detail',['restaurant_id'=>$restaurant->restaurant_id, 'tab'=>'review']) }}">{{('Review')}}</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <div class="flex-start">
                                <div class="mx-1"><h3>{{('Reviews')}}</h3></div>
                                <div><h3><span style="color: red;">({{$review->total()}})</span></h3></div>
                            </div>
                        </div>
                        <div class="table-responsive datatable-custom">
                            <table id="datatable" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                                ...
                                <tr>
                                    <td>{{$review->firstItem()+$k}}</td>
                                    <td>{{$r->order_id}}</td>
                                    <td>{{$r->name}}</td>
                                    <td>{{$r->mobile}}</td>
                                    <td>{{$r->restaurant_rate}}</td>
                                    <td>{{$r->restaurant_review}}</td>
